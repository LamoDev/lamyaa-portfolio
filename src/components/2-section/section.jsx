      ...
      <section id="contact" className="my-Section  flex"> 
        ...
        <div className="avatar flex">
           ...
           transition={{damping:6 , type:"spring"}}
            ...
            src="/logo-modified.png"  className="logo" alt="logo"/>
        ...
        <div className="icons-container flex">
            ...
            <a href='' target='_blank'><div className="icon icon-linkedin-square"></div></a>
            <a href='https://github.com/LamoDev' target='_blank'><div className="icon icon-github"></div></a>
        </div>
